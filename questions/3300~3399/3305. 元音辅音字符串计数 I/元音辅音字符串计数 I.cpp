/* 元音辅音字符串计数 I.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
...
public:
    int countOfSubstrings(string word, int k) {
        int size = (int)word.size(), subs = 0, R1 = 0, consonants = 0;
...
int main()
{
    ...
    check.checkInt(0, o.countOfSubstrings("aeioqq", 1));
    check.checkInt(1, o.countOfSubstrings("aeiou", 0));
    check.checkInt(3, o.countOfSubstrings("ieaouqqieaouqq", 1));
    check.checkInt(3, o.countOfSubstrings("iqeaouqi", 2));
}
