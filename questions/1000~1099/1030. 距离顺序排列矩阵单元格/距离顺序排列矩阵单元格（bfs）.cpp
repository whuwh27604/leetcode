...
int main()
{
    ...
    expected = { {1,2}, {1,1}, {0,2}, {1,0}, {0,1}, {0,0} };
    check.checkIntVectorVector(expected, actual);

    actual = o.allCellsDistOrder(4, 4, 3, 3);
    expected = { {3,3}, {3,2}, {2,3}, {3,1}, {2,2}, {1,3}, {3,0}, {2,1}, {1,2}, {0,3}, {2,0}, {1,1}, {0,2}, {1,0}, {0,1}, {0,0} };
    check.checkIntVectorVector(expected, actual);

    actual = o.allCellsDistOrder(1, 1, 0, 0);
    expected = { {0,0} };
    check.checkIntVectorVector(expected, actual);
}
