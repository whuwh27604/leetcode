/* 所有元音按顺序排布的最长子字符串.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
...
public:
    int longestBeautifulSubstring(string word) {
        int len = 0, maxLen = 0;
        char next['u' + 1] = { 0 };
        next['a' - 1] = 'a', next['a'] = 'e', next['e'] = 'i', next['i'] = 'o', next['o'] = 'u';
        char prev = 'a' - 1;

        for (char c : word) {
            if (c == prev || c == next[prev]) {
                ++len;
                prev = c;
                if (c == 'u') {
...
int main()
{
    ...
    check.checkInt(0, o.longestBeautifulSubstring("a"));
    check.checkInt(0, o.longestBeautifulSubstring("aeio"));
    check.checkInt(5, o.longestBeautifulSubstring("aeeeiiiioooauuuaeiou"));
    check.checkInt(13, o.longestBeautifulSubstring("aeiaaioaaaaeiiiiouuuooaauuaeiu"));
    check.checkInt(5, o.longestBeautifulSubstring("uaeiou"));
    check.checkInt(6, o.longestBeautifulSubstring("aeiaaeiou"));
    check.checkInt(2169, o.longestBeautifulSubstring(""));
