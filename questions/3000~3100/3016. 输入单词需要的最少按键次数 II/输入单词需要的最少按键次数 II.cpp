/* 输入单词需要的最少按键次数 II.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
...
int main()
{
	...
	check.checkInt(12, o.minimumPushes("xyzxyzxyzxyz"));
	check.checkInt(24, o.minimumPushes("aabbccddeeffgghhiiiiii"));
}
