/* 单调数组对的数目 I.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
...
int main()
{
    ...
    nums = { 5,5,2,3,2,5,5,5,5,2,3,2,5,5,5,5,2,3,2,5,5,5,5,2,3,2,5,5,5,5,2,3,2,5,5,5,5,2,3,2,5,5,5,5,2,3,2,5,5,5,5,2,3,2,5,5 };
    check.checkInt(0, o.countOfPairs(nums));
}
